...
@WebServlet(name = "stopSimulation", urlPatterns = "/stopSimulation")
public class stopSimulation extends HttpServlet {
...
//        }
        ...
        try {
            engine.stopSimulation(simulationId.getSimulationId());
        }catch (Exception e){
